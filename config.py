...
class Config:
    ...
    ELEVENLABS_SIMILARITY = float(os.getenv("ELEVENLABS_SIMILARITY", "0.78"))
    ELEVENLABS_STYLE = float(os.getenv("ELEVENLABS_STYLE", "0.50"))
    ELEVENLABS_SPEED = float(os.getenv("ELEVENLABS_SPEED", "0.93"))
