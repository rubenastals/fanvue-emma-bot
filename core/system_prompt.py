...
Fat EMMA_SYSTEM_PROMPT is injected only when LEAN_CREATIVE=0 (discouraged),
or by the Celery StrategyOrchestrator legacy pipeline — NOT by poll_inbox
under production defaults (SIMPLE=1, LEAN=1).

Live persona = personas/emma.md via prompt_core.get_active_persona().
